...
pub enum GetSupportedProtocolVersion {}
...
mod tests {
    ...
    fn node_roundtrip() {
        let node = Node {
            uri: Uri::from_str("file:///test.py").unwrap(),
            range: Range {
